...
@endif
     <ul class="nav nav-pills">
          <li role="presentation" ><a href="{!!URL::to('/proveedor')!!}">Proveedores Activos</a></li>
          <li role="presentation"  class="active"><a href="{!!URL::to('/proveedor/off')!!}">Proveedores Inactivos</a></li>
    </ul>
      <br>
        <div class="row">
          <div class="col-xs-12">
            <div class="box">
              <div class="box-header">
                  <h3 class="box-title">Listado de Proveedores Inactivos</h3>
              </div><!-- /.box-header -->
                  <br>
              <div class="box-body">
